...
#
# Script generated by Vivado on Sun Feb 15 20:19:44 -0700 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/School/SeniorProject/DAC_pmod_testing/DAC_pmod_testing.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
