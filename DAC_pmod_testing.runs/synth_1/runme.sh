...
HD_PWD='E:/School/SeniorProject/DAC_pmod_testing/DAC_pmod_testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_Pmod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_Pmod.tcl
