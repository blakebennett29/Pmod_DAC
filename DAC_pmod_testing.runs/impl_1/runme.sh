...
HD_PWD='E:/School/SeniorProject/DAC_pmod_testing/DAC_pmod_testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_Pmod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DAC_Pmod.tcl -notrace
